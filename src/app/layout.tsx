...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${inter.variable} ${playfair.variable}`}>
      ...
      <body className="min-h-[100dvh] overflow-x-clip bg-white font-sans text-gray-900">
        ...
        <div className="fixed top-1/2 right-1/4 h-40 w-40 rounded-full bg-emerald-200/15 blur-3xl animate-pulse-soft pointer-events-none -z-10" />
